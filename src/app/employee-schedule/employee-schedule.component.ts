...
export class EmployeeScheduleComponent implements OnInit {
  ...
  //   const from = new Date(this.dateFrom).toLocaleDateString('en-CA');
  //   const to   = new Date(this.dateTo).toLocaleDateString('en-CA');
  ...
  downloadSchedulePDF() {
    ...
    img.onload = () => {
      ...
      autoTable(doc, {
        ...
        didDrawPage: (data) => {
          // Calculate table width based on page width and margins
          const pageWidth = doc.internal.pageSize.getWidth();
          const marginRight = 40; // same as table margin
      ...
      // doc.save(`Weekly-Schedule-${weekId}.pdf`);
    };
